...
Students are encouraged to regularly complete/update an IDP. A good template is [myIDP](http://myidp.sciencecareers.org/) but students may use another format. IDPs can be used to receive feedback from the mentors on the skills related to their goals (i.e., skills needed for careers of interest) and to facilitate conversations around planning training goals (short- and long-term).
